...
class _BmiScreenState extends State<BmiScreen> {
  ...
  String heightMassage = '';
  String weightMassage = '';
  ...
  Widget build(BuildContext context) {
    ...
    weightMassage =
        'Please insert you weight in ' + ((isImperial) ? 'kilos' : 'pounds');
    return Scaffold(
      ...
      body: Column(children: [
        ...
        TextField(
            ...
            decoration: InputDecoration(hintText: heightMassage)),
        TextField(
            controller: txtWeight,
            keyboardType: TextInputType.number,
            decoration: InputDecoration(hintText: weightMassage)),
        ElevatedButton(
